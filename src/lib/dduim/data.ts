...
export const baseCourses: Course[] = [
  {
    ...
    startPoint: { lat: 37.52693, lng: 126.93447 },
    geoPath: [
      { lat: 37.52693, lng: 126.93447 },
      { lat: 37.52811, lng: 126.92978 },
      { lat: 37.53078, lng: 126.92569 },
      { lat: 37.53304, lng: 126.92234 },
      { lat: 37.53608, lng: 126.92451 },
      { lat: 37.53786, lng: 126.92929 },
      { lat: 37.53645, lng: 126.93412 },
      { lat: 37.53321, lng: 126.93697 },
      { lat: 37.52984, lng: 126.93612 },
      { lat: 37.52693, lng: 126.93447 },
    ],
    tags: [
      { text: "한강뷰", emoji: "🌊", color: "sky" },
  ...
  },
  {
    ...
    startPoint: { lat: 37.55122, lng: 126.98819 },
    geoPath: [
      { lat: 37.55122, lng: 126.98819 },
      { lat: 37.55368, lng: 126.99041 },
      { lat: 37.55562, lng: 126.99416 },
      { lat: 37.55441, lng: 126.9982 },
      { lat: 37.55102, lng: 126.99902 },
      { lat: 37.54822, lng: 126.99644 },
      { lat: 37.54754, lng: 126.99203 },
      { lat: 37.5491, lng: 126.98889 },
      { lat: 37.55122, lng: 126.98819 },
    ],
    tags: [
  ...
  },
  {
    ...
    startPoint: { lat: 37.47832, lng: 127.03911 },
    geoPath: [
      { lat: 37.47832, lng: 127.03911 },
      { lat: 37.47694, lng: 127.04288 },
      { lat: 37.47578, lng: 127.04736 },
      { lat: 37.47457, lng: 127.0512 },
      { lat: 37.47381, lng: 127.05505 },
      { lat: 37.47295, lng: 127.05892 },
    ],
    tags: [
      { text: "벚꽃", emoji: "🌸", color: "pink" },
      { text: "초보환영", emoji: "🙂", color: "yellow" },
  ...
  },
  {
    ...
    saves: 562,
    anchor: { x: 0.85, y: 0.5 },
    startPoint: { lat: 37.51138, lng: 127.10255 },
    geoPath: [
      { lat: 37.51138, lng: 127.10255 },
      { lat: 37.51278, lng: 127.10491 },
      { lat: 37.51187, lng: 127.10831 },
      { lat: 37.50982, lng: 127.10944 },
      { lat: 37.50795, lng: 127.10711 },
      { lat: 37.5083, lng: 127.10372 },
      { lat: 37.51014, lng: 127.10196 },
      { lat: 37.51138, lng: 127.10255 },
    ],
    tags: [
      { text: "호수뷰", emoji: "💧", color: "sky" },
